...
public class ScatterViewer extends ConcreteViewer {
			...
			public void updateGraphics(JPanel myPanel) {
				...
				LineAndShapeRenderer itemrenderer1 = new LineAndShapeRenderer(false, true);
				LineAndShapeRenderer itemrenderer2 = new LineAndShapeRenderer(false, true);
				...
				JFreeChart scatterChart = new JFreeChart(this.analysisName,
				...
				LineAndShapeRenderer r = (LineAndShapeRenderer)scatterChart.getCategoryPlot().getRenderer();
